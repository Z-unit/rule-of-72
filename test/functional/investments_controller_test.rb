...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { interest_rate: @investment.interest_rate, principle: @investment.principle, time_horizion: @investment.time_horizion }
    end
  ...
  test "should update investment" do
    put :update, id: @investment, investment: { interest_rate: @investment.interest_rate, principle: @investment.principle, time_horizion: @investment.time_horizion }
    assert_redirected_to investment_path(assigns(:investment))
  end
